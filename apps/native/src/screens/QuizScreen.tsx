...
import { QuizStoreModel } from "../models/QuizStore";
...
export const QuizScreen = ({
  ...
  const [quizStore] = useState(() => QuizStoreModel.create());
  ...
  const {
    ...
    error,
    refetch,
  } = useRandomQuestions(category, subcategory, quizLength, true);
        ...
        <View className="flex-row justify-between">
          <TouchableOpacity
            className={`px-6 py-3 rounded-lg ${
              quizStore.currentQuestionIndex > 0 ? "bg-gray-200" : "bg-gray-100"
            }`}
